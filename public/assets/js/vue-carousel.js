    ...
    return function(t) {
        ...
        e.default = {
            ...
            methods: {
                ...
                setSize: function() {
                    this.$el.style.cssText += "height:" + 500 + "px;", this.$el.childNodes[0].style.cssText += "width:" + this.slideWidth + "px; height:" + this.slideHeight + "px;"
                }
            },
            mounted: function() {
        ...
        t.exports = {
            render: function() {
                ...
                return n("div", {
                    ...
                    style: "width: " + t.width + "px; height: " + 500+ "px; line-height: " + 500 + "px;",
                    attrs: {
                        href: "#"
                    },
                    on: {
